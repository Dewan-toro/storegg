        ...
        <div className="row mt-30 mb-20">
          <div className="col-lg-12 col-12 main-content">
            <div id="list_status_title">
              ...
              <ButtonTab title="Failded" active={false} />
            </div>
          </div>
        </div>
          ...
          <div className="main-content main-content-table overflow-auto">
            <table className="table table-borderless">
              ...
              <tbody id="list_status_item">
                ...
                <TableRow image="overview-3" title="Call of Duty:Modern" category="Desktop" item={550} price={740000} status="Failed" />
                <TableRow image="overview-4" title="Call of Duty:Modern" category="Desktop" item={550} price={740000} status="Pending" />
              </tbody>
            </table>
          </div>
        </div>
